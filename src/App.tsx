		...
		<Container maxWidth="sm" className="app">
			...
			<Container>
				...
				<Container style={{ display: 'flex', justifyContent: 'center', }}>
					<Button className="btn-health" color="primary" variant="contained" onClick={() => { api.pingApiHealthEndpoint() }}>Server Up?</Button>
					<Button className="btn-token" color="secondary" variant="contained" onClick={() => { api.pingTokenCheckEndpoint() }}>Token valid?</Button>
				</Container>
				{/* <IconDemo/> */}
			</Container>
